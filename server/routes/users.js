...
router.get(
  "/getByIndex/:id",
  checkAuth([constants.ROLE_TYPE_ADMIN, constants.ROLE_TYPE_ORGANIZER]),
...
router.post(
  "/requestRole",
  checkAuth([constants.ROLE_TYPE_USER]),
  UserController.requestRole
);
